...
import { logConfig } from "./dare-console-logger.js";
import { decodeBase64 } from "../deps/jsr.io/@std/encoding/1.0.10/mod.js";
...
export function safeStringify(obj : object, space?: number): string {
